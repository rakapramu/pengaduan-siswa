...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('dashboard') }}/compiled/svg/favicon.svg" type="image/x-icon">
            ...
            <div class="card shadow-lg border-0 rounded-4" style="max-width: 420px; width: 100%;">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-center mb-4">
                        <a href="#">
                            <img src="{{ asset('dashboard/compiled/svg/logo.svg') }}" alt="Logo" width="80">
                        </a>
                    ...
                    <form action="{{ route('loginAction') }}" method="POST">
                        ...
                        <button class="btn btn-primary btn-lg w-100 shadow-sm">Log in</button>
                    </form>
                </div>
            </div>
        </div>
